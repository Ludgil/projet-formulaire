        ...
        <form id="formulare" action="checkForm.php" method="POST">
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <p><input type="text" name="useFirstname" id="formUseFirstname" required maxlength=30 aria-label="firstname" aria-describedby="user firstname" aria-required="true"></p>
                </div>
                <div class="col-md-5">
                    <label> Lasttname</label>
                    <p><input type="text" name="useLastname" id="formUseLastname" required maxlength=30 aria-label="lastname" aria-describedby="user lastname" aria-required="true"></p>
                </div>
            </div>
             <!--  deuxième ligne  -->
            <div class="row justify-content-start">
                <div class="col-md-10">
                    <label>Mail</label>
                    <p><input type="text" name="usemail" id="formMail" required maxlength=80 size=50 aria-label="mail" aria-describedby="user mail address" aria-required="true"></p>
                </div>
            </div>
             <!--  troisième ligne  -->
